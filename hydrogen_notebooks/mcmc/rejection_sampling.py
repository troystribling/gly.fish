...
acceptance_plot(title, weibull_pdf, x_samples, nsamples, ymax, xmax, (0.4, 0.75), "weibull_uniform_efficiency")
...
target_label = r"$f(x)=Weibull(k={k}, λ={λ})$".format(k=k, λ=λ)
proposal_label = r"$g(x)=Normal(μ={μ}, σ={σ})$".format(μ=μ, σ=σ)
