...
file_prefix = "gibbs-bivariate-normal-γ-0.0"
...
bv.contour_plot(μ1, μ2, σ1, σ2, γ, [0.01, 0.05, 0.1, 0.15, 0.2], "hamiltonian_monte_carlo", "gibbs-bivariate-normal-target-pdf")
