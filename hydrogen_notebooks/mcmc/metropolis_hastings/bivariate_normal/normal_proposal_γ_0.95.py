...
file_prefix = "mh-bivariate-normal-γ-0.95"

# %%

bv.contour_plot(μ1, μ2, σ1, σ2, γ, [0.01, 0.1, 0.2, 0.3, 0.4], "hamiltonian_monte_carlo", "metropolis-hastings-bivariate-normal-target-pdf")
