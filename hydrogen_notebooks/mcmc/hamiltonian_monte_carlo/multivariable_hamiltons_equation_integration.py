...
H = U_t + K_t
time = numpy.linspace(0.0, t, nsteps+1)
hmc.time_series(title, H, time, [-1.0, 3.0], "hamiltonian-timeseries-3")
...
hmc.multicurve(title, [q[:,0], q[:,1]], time, "Time", "q", [r"$q_1$", r"$q_2$"],  (0.15, 0.8), [-4.2, 4.2], "position-timeseries-3")

# %%

hmc.multicurve(title, [p[:,0], p[:,1]], time, "Time", "p", [r"$p_1$", r"$p_2$"],  (0.2, 0.9), [-10.2, 10.2], "momentum-timeseries-3")
